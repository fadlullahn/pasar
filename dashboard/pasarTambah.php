...
<body>
    <div class="container">
        <div class="row">
            ...
            ?>
                <div class="col-md-6">
                    <form id="signupForm" class="card-form">
                        <div class="bg-white shadow-md rounded-lg">
                            <div class="bg-gray-800 text-white text-center py-2 rounded-t-lg">
                                <strong>Input Data Pasar</strong>
                            </div>
                            <div class="p-4">
                                <div>
                                    <label for="latitude" class="block text-sm font-medium leading-6 text-gray-900">Latitude</label>
                                    <div class="mt-2">
                                        <input name="username" type="text" autocomplete="off" required class="p-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            id="latitude" name="latitude" placeholder="-4.0099" required>
                                    </div>
                                </div>
                                <div class="mt-1">
                                    ...
                                    <div class="mt-2">
                                        <input name="username" type="text" autocomplete="off" required class="p-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            id="longitude" name="longitude" placeholder="119.6290" required>
                                    </div>
                                </div>
                                <div class="mt-1">
                                    <label for="nsentral" class="block text-sm font-medium leading-6 text-gray-900">Sentral</label>
                                    <div class="mt-2">
                                        <select name="nsentral" id="nsentral" autocomplete="off" required class="p-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="mt-1">
                                    <label for="nama" class="block text-sm font-medium leading-6 text-gray-900">Nama Pasar</label>
                                    <div class="mt-2">
                                        <input name="username" type="text" autocomplete="off" required class="p-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            id="nama" name="nama" placeholder="Nama Pasar" required>
                                    </div>
                                </div>
                                <div class="mt-1">
    ...
    <script>
        ...
        function addMarker(ltlng, event) {
            if (event === 'click') {
                pasar_parepare = ltlng;
            }
            marker = new mapboxgl.Marker({
                    draggable: true,
                    color: "#d02922"
                })
                .setLngLat(pasar_parepare)
                .addTo(map)
        ...
        $('#signupForm').submit(function(event) {
            ...
            var nsentral = $('#nsentral').val();
            var nama = $('#nama').val();
            var deskripsi = $('#deskripsi').val();
            var url = 'pasarFunc.php?tambah_pasar&latitude=' + lat + '&longitude=' + lng + '&nsentral=' + nsentral + '&nama=' + nama + '&deskripsi=' + deskripsi;
            $.ajax({
                url: url,
                method: 'GET',
                dataType: 'json',
